@ From SkillSys.
@ Replaces proc_start at 0xB82EF8 in LnLVer0.0.16.
@ Doesn't roll for a miss if procced skill is set to Dual Strike.
...
@ LnLVer0.0.16
.equ BarricadeIDLink, 0x8B83059
.equ BarricadePlusIDLink, 0x8B8305A
.equ ExpertiseIDLink, 0x8B83058
.equ SkillTester, 0x8B60944
